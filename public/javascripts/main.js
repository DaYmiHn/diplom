...
$('#star-rating').rating(function(vote, event){
  // console.log(vote)
    socket.emit('finish package', {id:current_finish_package, vote: vote},()=>{
        $('input.donePackage.google_but[data-id='+current_finish_package+']').parent().parent().remove();
        $('#finish > a').click()
    });
});
