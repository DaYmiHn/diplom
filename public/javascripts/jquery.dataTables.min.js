...
sNext:"След.",sPrevious:"Пред."},sEmptyTable:"Нет данных для отображения",sInfo:"Показано с _START_ по _END_ из _TOTAL_ записей",sInfoEmpty:"Показано с 0 по 0 из 0 записей",sInfoFiltered:"(отфильтровано из _MAX_ записей)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"_MENU_",sLoadingRecords:"Загружается...",sProcessing:"Выполняется...",sSearch:"Поиск:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Совпадений не найдено"},oSearch:f.extend({},q.models.oSearch),sAjaxDataProp:"data",
